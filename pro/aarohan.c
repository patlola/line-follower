...
void linel(void){
            ...
            if( PINA.0 == 0 && PINA.1 == 0 && PINA.2 == 0) { 
                ...
                delay_ms(8);
                for(w=0;w<22;w++){PORTD.2 = 1;  PORTD.3 = 0;    PORTD.7 = 0;    PORTD.6 = 0;
                delay_ms(1);
                PORTD.2 = 0;  PORTD.3 = 0;    PORTD.7 = 0;    PORTD.6 = 0;
                delay_ms(4);      }
                x=0;
...
void lined(void){
            ...
            if( PINA.0 == 0 && PINA.1 == 0 && PINA.2 == 0) {
                PORTD.2 = 0;  PORTD.3 = 1;    PORTD.7 = 0;    PORTD.6 = 1;
                delay_ms(6);
                for(w=0;w<24;w++){PORTD.2 = 1;  PORTD.3 = 0;    PORTD.7 = 0;    PORTD.6 = 1;
                delay_ms(1);
                PORTD.2 = 0;  PORTD.3 = 0;    PORTD.7 = 0;    PORTD.6 = 0;
                delay_ms(4);      }
                x=0;
...
void liner(void){
            ...
            if( PINA.0 == 0 && PINA.1 == 0 && PINA.2 == 0) {
                PORTD.2 = 0;  PORTD.3 = 1;    PORTD.7 = 0;    PORTD.6 = 1;
                delay_ms(6);
                for(w=0;w<22;w++){PORTD.2 = 0;  PORTD.3 = 0;    PORTD.7 = 1;    PORTD.6 = 0;
                delay_ms(1);
                PORTD.2 = 0;  PORTD.3 = 0;    PORTD.7 = 0;    PORTD.6 = 0;
                delay_ms(4);}
                y=0;
...
while (1)
      ...
      if(PINA.3 == 0 && PINA.5 == 0){
            linen();
      }
            
            }
      if( z == 1 && x==1 && PINA.5==1) y=1;
      if( z == 1 && y==1 && PINA.3==1) x=1;
      if(z==1){
            if(x==1 && y==1){ 
                lined();
                continue;
