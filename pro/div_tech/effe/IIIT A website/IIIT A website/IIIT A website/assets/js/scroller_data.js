    ...
    
    {
      ...
      'stories': [
        
        {
          'id': 'institute',
          'name': 'The Institute',
          'short_desc': '<a href="#">About Us</a><a href="#">Infrastructure</a><a href="#">Reaching iiita</a><a href="#">RTI</a>',
          'order': '1',
          'image': 1,
          'content_type': 'Video',
        },
        
        {
          'id': 'academics',
          'name': 'Academics',
          'short_desc': '<a href="#">Board of Management</a><a href="#">Academic Council</a><a href="#">Finance Committee</a><a href="#">Building & Works Committee</a>',
          'order': '2',
          'image': 1,
        ...
        
        {
          'id': 'student_life',
          'name': 'Student Life',
          'short_desc': '<a href=\"#">Fresher\'s Guide</a><a href="#">Photo Gallery</a><a href="#">Hostel Life</a><a href="#">Clubs</a>',
          'order': '3',
          'image': 1,
          'content_type': 'External Article',
        },
        
        {
          'id': 'facilities',
          'name': 'Facilities',
          'short_desc': '<a href="#">Laboratories</a><a href="#">Sports Facilities</a><a href="#">Medical Facilities</a>',
          'order': '4',
          'image': 1,
          'content_type': 'Video',
        },
        ...
        
        {
          'id': 'placements',
          'name': 'Placements',
          'short_desc': '<a href="#">BTech</a><a href="#">MTech</a><a href="#">MBA</a><a href="#">MS</a>',
          'order': '5',
          'image': 1,
          'content_type': 'External Article',
        },
        
        {
          'id': 'research',
          'name': 'Research Labs',
          'short_desc': '<a href="#">Student Projects</a><a href="#">Robotics</a><a href="#">Research Net</a><a href="#">SLIP Research Group</a>',
          'order': '6',
          'image': 1,
          'content_type': 'Video',
        },
      ...
      if (type['stories']) {
        ...
        for (j=0; j<max; j++) {
          ...
          if (story['image']) {
            ...
            html += '><img src="imgs/img_' + story['id'] + '.jpg" /></a>';
          }
