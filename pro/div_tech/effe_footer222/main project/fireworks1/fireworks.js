...
FireworkDisplay = {
    ...
    launchText :  function() {
       ...
       //MAIN TEXT TO BE DISPLAYED LIES HERE 
        var text = "EFFERVESCENCE MM12";
    ...
    displayFirework : function(fw, speed) {
        ...
        if (fw.status==this.FIREWORK_EXPLODED) {
            this.ctx.beginPath();
            this.ctx.fillStyle = "rgb(200, 00, 00)";
        ...
        fw.colour = "rgb(80, 80, 80)"; //color of stream which paints
