...
; 0000 0046 // Mode: Fast PWM top=0x00FF
; 0000 0047 // OC1A output: Non-Inverted PWM
; 0000 0048 // OC1B output: Non-Inverted PWM
; 0000 0049 // Noise Canceler: Off
; 0000 004A // Input Capture on Falling Edge
; 0000 004B // Timer Period: 2.048 ms
; 0000 004C // Output Pulse(s):
; 0000 004D // OC1A Period: 2.048 ms Width: 0 us// OC1B Period: 2.048 ms Width: 0 us
...
; 0000 0052 TCCR1A=(1<<COM1A1) | (0<<COM1A0) | (1<<COM1B1) | (0<<COM1B0) | (0<<WGM11) | (1<<WGM10);
	LDI  R30,LOW(161)
	OUT  0x2F,R30
; 0000 0053 TCCR1B=(0<<ICNC1) | (0<<ICES1) | (0<<WGM13) | (1<<WGM12) | (0<<CS12) | (1<<CS11) | (1<<CS10);
	LDI  R30,LOW(11)
	OUT  0x2E,R30
...
_0x7:
; 0000 008A       {
; 0000 008B     if( PINA.0 == 1 && PINA.1 == 0 && PINA.2 == 1) {
	SBIS 0x19,0
	RJMP _0xB
	RCALL SUBOPT_0x0
	BRNE _0xB
...
; 0000 0091             OCR1B = 50;
	RCALL SUBOPT_0x2
; 0000 0092             delay_ms(4);
; 0000 0093     }
; 0000 0094 
; 0000 0095     if( PINA.0 == 0 && PINA.1 == 0 && PINA.2 == 0) {
_0xA:
	LDI  R26,0
	SBIC 0x19,0
	LDI  R26,1
...
; 0000 009A             OCR1A = 50;
; 0000 009B            // OCR1B = 50;
; 0000 009C             delay_ms(4);
	LDI  R26,LOW(4)
	LDI  R27,0
	RCALL _delay_ms
; 0000 009D     }
; 0000 009E 
; 0000 009F     if( PINA.0 == 1 && PINA.1 == 1) {
_0x15:
	SBIS 0x19,0
	RJMP _0x21
	SBIC 0x19,1
...
; 0000 00A5             OCR1B = 10;
	...
	OUT  0x28+1,R31
	OUT  0x28,R30
; 0000 00A6             delay_ms(4);
	LDI  R26,LOW(4)
	LDI  R27,0
	RCALL _delay_ms
; 0000 00A7     }
; 0000 00A8 
; 0000 00A9     if( PINA.1 == 1 && PINA.2 == 1) {
_0x20:
	SBIS 0x19,1
	RJMP _0x2C
	SBIC 0x19,2
...
; 0000 00B1     }
; 0000 00B2 
; 0000 00B3     if( PINA.0 == 1 && PINA.1 == 1 && PINA.2 == 1) {
_0x2B:
	SBIS 0x19,0
	RJMP _0x37
	SBIS 0x19,1
