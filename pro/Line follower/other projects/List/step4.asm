...
; 0000 007B             {
; 0000 007C 
; 0000 007D                 if(PIND.0==1 && PIND.1==1 && PIND.2==1){
	SBIS 0x10,0
	RJMP _0xF
	SBIS 0x10,1
	RJMP _0xF
...
_0xF:
	RJMP _0xE
_0x10:
; 0000 007E                     PORTA.0=1;                                //M1
	SBI  0x1B,0
; 0000 007F                     PORTA.1=0;
	CBI  0x1B,1
; 0000 0080 
; 0000 0081                     PORTA.6=1;                                //M2
	SBI  0x1B,6
; 0000 0082                     PORTA.7=0;
	CBI  0x1B,7
; 0000 0083 
; 0000 0084                     delay_us(400);
	__DELAY_USW 800
...
; 0000 0087                 }
; 0000 0088 
; 0000 0089                 else if(PIND.0==0){
_0xE:
	SBIC 0x10,0
	RJMP _0x1A
; 0000 008A                     PORTA.0=0;                                //M1
	CBI  0x1B,0
; 0000 008B                     PORTA.1=0;
	CBI  0x1B,1
; 0000 008C 
; 0000 008D                     PORTA.6=1;                                //M2
	SBI  0x1B,6
; 0000 008E                     PORTA.7=0;
	RJMP _0x2F
; 0000 008F 
; 0000 0090                     delay_us(200);
; 0000 0091                     PORTA=0;
; 0000 0092                 }
; 0000 0093 
; 0000 0094                 else if(PIND.2==0){
_0x1A:
	SBIC 0x10,2
	RJMP _0x24
; 0000 0095                     PORTA.0=1;                                //M1
	SBI  0x1B,0
; 0000 0096                     PORTA.1=0;
	CBI  0x1B,1
; 0000 0097 
; 0000 0098                     PORTA.6=0;                                //M2
	CBI  0x1B,6
; 0000 0099                     PORTA.7=0;
_0x2F:
	CBI  0x1B,7
; 0000 009A 
; 0000 009B                     delay_us(200);
	__DELAY_USW 400
; 0000 009C                     PORTA=0;
_0x2E:
	LDI  R30,LOW(0)
